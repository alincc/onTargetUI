...
gulp.task('build', ['requireJsOptimizer'], function() {
  ...
  return gulp.src('src/javascripts/main.min.js')
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.default.newBimServer + "'"))
...
gulp.task('build:local', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.local.newBimServer + "'"))
...
gulp.task('build:integration', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.integration.newBimServer + "'"))
...
gulp.task('build:beta', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.beta.newBimServer + "'"))
...
gulp.task('build:testing', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.testing.newBimServer + "'"))
...
gulp.task('build:staging', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.staging.newBimServer + "'"))
...
gulp.task('build:production', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.production.newBimServer + "'"))
...
gulp.task('build:sagarmatha01', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.sagarmatha01.newBimServer + "'"))
...
gulp.task('build:sagarmatha02', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.sagarmatha02.newBimServer + "'"))
...
gulp.task('build:nois', ['build'], function() {
  ...
  gulp.src(['./src/javascripts/main.min.js'])
    ...
    .pipe(replace(/newBimServer: '.*'/, "newBimServer: '" + config.nois.newBimServer + "'"))
