...
gulp.task('build:local', ['build'], function(){
  ...
  gulp.src('./app.js')
    .pipe(replace("('port', 9000)", "('port', " + config.local.port + ")"))
...
gulp.task('build:integration', ['build'], function(){
  ...
  // Copy app.js and modify value
  gulp.src('./app.js')
    .pipe(replace("('port', 9000)", "('port', " + config.integration.port + ")"))
...
gulp.task('build:testing', ['build'], function(){
  ...
  // Copy app.js and modify value
  gulp.src('./app.js')
    .pipe(replace("('port', 9000)", "('port', " + config.testing.port + ")"))
...
gulp.task('build:staging', ['build'], function(){
  ...
  // Copy app.js and modify value
  gulp.src('./app.js')
    .pipe(replace("('port', 9000)", "('port', " + config.staging.port + ")"))
...
gulp.task('build:production', ['build'], function(){
  ...
  // Copy app.js and modify value
  gulp.src('./app.js')
    .pipe(replace("('port', 9000)", "('port', " + config.production.port + ")"))
