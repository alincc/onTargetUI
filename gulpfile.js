...
gulp.task('build:server', function() {
  ...
  gulp.src('server/config.js', {"base": "."})
    ...
    .pipe(replace(/maxFileSize: 5000000/g, 'maxFileSize: ' + config.server.maxFileSize))
...
gulp.task('build:serverlocal', function() {
  ...
  gulp.src('server/config.js', {"base": "."})
    ...
    .pipe(replace(/maxFileSize: 5000000/g, 'maxFileSize: ' + config.serverlocal.maxFileSize))
...
gulp.task('build:serverintegration', function() {
  ...
  gulp.src('server/config.js', {"base": "."})
    ...
    .pipe(replace(/maxFileSize: 5000000/g, 'maxFileSize: ' + config.serverintegration.maxFileSize))
...
gulp.task('build:serverbeta', function() {
  ...
  gulp.src('server/config.js', {"base": "."})
    ...
    .pipe(replace(/maxFileSize: 5000000/g, 'maxFileSize: ' + config.serverbeta.maxFileSize))
...
gulp.task('build:serversagarmatha01', function() {
  ...
  gulp.src('server/config.js', {"base": "."})
    ...
    .pipe(replace(/maxFileSize: 5000000/g, 'maxFileSize: ' + config.serversagarmatha01.maxFileSize))
