...
module.exports = {
  exportPdf: function(req, res) {
    ...
    function success() {
      ...
      console.log('Starting Export PDF...Done');
      res.send({
        success: true,
    ...
    function fillPOData(html, data) {
      try {
        ...
        console.log('Replacing attachments');
        ...
        validateCompanyLogo(data.companyLogoKey)
          .then(function(companyLogoPath) {
            ...
            console.log('Remove file on S3 if it exists...');
            aws.s3.removeFileIfExists(key)
              .then(function() {
                console.log('Remove file on S3 if it exists...Done!');
    ...
    function fillRFIData(html, data) {
      try {
        ...
        console.log('Replacing responses');
        // Responses
    ...
    switch(data.documentTemplate.documentTemplateId) {
      case 1:
        getCompanyDetails(baseRequest)
          .then(function(dt) {
            console.log('Get company details...Done!');
            console.log('Get document attachment...');
      ...
      case 2:
        getCompanyDetails(baseRequest)
          .then(function(dt) {
            ...
            getAttachments(baseRequest, data.documentId)
              .then(function(attachments) {
                console.log('Get document attachment...Done!');
