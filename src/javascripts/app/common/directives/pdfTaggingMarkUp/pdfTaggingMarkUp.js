      ...
      return {
        ...
        link: function(scope, elem) {
          var imgH, imgW, map, markerCount = 1,
            ...
            southWest, northEast, bounds, currentlyEditing, disableEditing = false, isMoving = false;
          ...
          function updatePositionMarkers(layer) {
            function _getCorners() {
              var bounds = layer.editing._shape.getBounds(),
            ...
            var corners = layer.editing._getCorners();
            for(var i = 0, l = layer.editing._resizeMarkers.length; i < l; i++) {
              layer.editing._resizeMarkers[i].setLatLng(corners[i]);
            }
          }

          function updateLayerPosition(layer, newCenter) {
            var latlngs = layer.editing._shape.getLatLngs(),
              bounds = layer.editing._shape.getBounds(),
            ...
            layer.editing._shape.setLatLngs(newLatLngs);
          }
          ...
          function stopEditing() {
            ...
            scope.listLayers.push(currentlyEditing);
