define(function(require) {
  ...
  module.factory('utilFactory', ['countryFactory', '$q', '$http', 'appConstant',
    function(countryFactory, $q, $http, appConstant) {
      var services = {};
      /**
      ...
      services.hash = function(message) {
        return CryptoJS.AES.encrypt(message, appConstant.app.salt, {}).toString();
      };
