...
define(function(require) {
  ...
  var module = angular.module('app.dashboard', ['ui.router', 'app.config', 'common.context.user', 'common.services.account', 'common.context.project', 'common.services.util', 'chart.js', 'ngScrollable', 'common.services.document', 'common.services.activity', 'common.filters.task']);
