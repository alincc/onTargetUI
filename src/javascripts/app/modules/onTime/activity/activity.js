define(function(require) {
  ...
  var module = angular.module('app.activity', ['ui.router', 'app.config', 'ngScrollable', 'common.context.user', 'common.services.project', 'common.services.company', 'common.services.activity']);
